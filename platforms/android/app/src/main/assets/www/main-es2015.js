...
module.exports = __webpack_require__(/*! /Users/umitaksoylu/Documents/Project/ionic_odev/src/main.ts */"zUnb");
...
let ProviderService = class ProviderService {
    constructor() { }
    refresh_calendar() { } //lambda function
    tasks_refresh() { } //lambda function
    refresh_profile() { } //lambda function
};
...
let Tab2Page = class Tab2Page {
    constructor(modalCtrl, alertCtrl, storage, provider) {
    ...
    addTaskModal() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const addTaskModal = yield this.alertCtrl.create({
    ...
    renameTask(index) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const renameTaskModal = yield this.alertCtrl.create({
                header: 'Görev ekleyin',
...
/* harmony import */ var _tab2_tab2_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./tab2/tab2.page */ "JZ9U");
/* harmony import */ var _ionic_storage__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic/storage */ "e8h1");
/* harmony import */ var ionic2_calendar__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ionic2-calendar */ "L+Ny");
/* harmony import */ var chartjs_plugin_zoom__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! chartjs-plugin-zoom */ "9jQl");
...
const routes = [
    {
        path: '',
        loadChildren: () => Promise.all(/*! import() | tabs-tabs-module */[__webpack_require__.e("default~auth-auth-module~survey-survey-module~tabs-tabs-module"), __webpack_require__.e("tabs-tabs-module")]).then(__webpack_require__.bind(null, /*! ./tabs/tabs.module */ "hO9l")).then(m => m.TabsPageModule)
    },
    {
        path: 'scheduler',
        loadChildren: () => __webpack_require__.e(/*! import() | scheduler-scheduler-module */ "scheduler-scheduler-module").then(__webpack_require__.bind(null, /*! ./scheduler/scheduler.module */ "lzfX")).then(m => m.SchedulerPageModule)
    },
    {
        path: 'event-modal',
        loadChildren: () => __webpack_require__.e(/*! import() | event-modal-event-modal-module */ "event-modal-event-modal-module").then(__webpack_require__.bind(null, /*! ./event-modal/event-modal.module */ "PsZg")).then(m => m.EventModalPageModule)
    },
    {
        path: 'stats',
    ...
    {
        path: 'survey',
        loadChildren: () => Promise.all(/*! import() | survey-survey-module */[__webpack_require__.e("default~auth-auth-module~survey-survey-module~tabs-tabs-module"), __webpack_require__.e("survey-survey-module")]).then(__webpack_require__.bind(null, /*! ./survey/survey.module */ "UQSm")).then(m => m.SurveyPageModule)
    },
    {
        path: 'auth',
        loadChildren: () => Promise.all(/*! import() | auth-auth-module */[__webpack_require__.e("default~auth-auth-module~survey-survey-module~tabs-tabs-module"), __webpack_require__.e("auth-auth-module")]).then(__webpack_require__.bind(null, /*! ./auth/auth.module */ "Yj9t")).then(m => m.AuthPageModule)
    }
];
