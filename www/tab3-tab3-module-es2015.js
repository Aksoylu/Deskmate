...
/* harmony import */ var _provider_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../provider.service */ "74+B");
...
let Tab3Page = class Tab3Page {
    constructor(router, alertCtrl, storage, provider) {
        this.router = router;
    ...
    showAlert(_header, _subheader_, _message) {
    ...
    showDialog(_header, _subheader_, _message) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const alert = yield this.alertCtrl.create({
                header: _header,
                subHeader: _subheader_,
...
/* harmony import */ var ionic2_calendar__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ionic2-calendar */ "L+Ny");
